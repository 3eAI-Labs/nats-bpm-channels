...
/**
 * {@code spring.nats.camunda.sharding.*} — the instance-sharding gate (docs/13 D-F house
 ...
 */
@ConfigurationProperties(prefix = "spring.nats.camunda.sharding")
public class CamundaShardingProperties {
