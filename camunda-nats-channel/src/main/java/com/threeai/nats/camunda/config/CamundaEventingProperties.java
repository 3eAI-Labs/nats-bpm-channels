...
/**
 * {@code spring.nats.camunda.eventing.*} — the Event-Registry-parity gate (docs/12 D-F v2).
 ...
 */
@ConfigurationProperties(prefix = "spring.nats.camunda.eventing")
public class CamundaEventingProperties {
