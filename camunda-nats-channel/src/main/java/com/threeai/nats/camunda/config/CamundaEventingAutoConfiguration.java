...
import com.threeai.nats.camunda.eventing.DefinitionSubscriberFactory;
...
import com.threeai.nats.camunda.eventing.EventingReconciler;
import com.threeai.nats.camunda.eventing.EventingRegistry;
import com.threeai.nats.camunda.eventing.LocationDefinitionLoader;
 ...
 * {@code spring.nats.camunda.eventing.enabled=true} (D-F v2, default false): absent the gate,
 ...
 */
@AutoConfiguration(after = CamundaNatsAutoConfiguration.class)
@ConditionalOnClass(org.camunda.bpm.engine.ProcessEngine.class)
@ConditionalOnProperty(prefix = "spring.nats.camunda.eventing", name = "enabled", havingValue = "true")
@EnableConfigurationProperties(CamundaEventingProperties.class)
public class CamundaEventingAutoConfiguration {
    ...
    @Bean
    @Primary
    public OverlayedOutboundClassification camundaOutboundClassificationOverlay(
    ...
    public EventingReconciler eventingReconciler(RepositoryService repositoryService,
            ...
            CamundaEventingProperties properties, ResourceLoader resourceLoader,
    ...
    public EventingReconcileScheduler eventingReconcileScheduler(EventingReconciler eventingReconciler,
            EventingRegistry eventingRegistry, CamundaEventingProperties properties,
