...
/**
 * Flush-before-lock single-INSERT guard (ADR-0005 §2, BR-A2-002, US-A2). Proves that
 * {@link A2ExternalTaskBehavior#execute} produces exactly ONE {@code INSERT ... ACT_RU_EXT_TASK}
 * and ZERO follow-up {@code UPDATE} — i.e. the task is born already SENTINEL-locked in a single
 * flush, never locked via a second round-trip.
 *
 ...
 * infrastructure, not a repeat of the existing pattern.
 */
class CamundaA2GuardTest {
