...
class NatsMessageCorrelationSubscriberTest {
    ...
    /**
     * DP-1 (NFR-S1) — QA review finding (HIGH): the success-path DEBUG log used to
     * write the raw {@code businessKey} value via {@code kv("business_key", businessKey)}, which
     * may be telco PII (MSISDN/subscriber id).
