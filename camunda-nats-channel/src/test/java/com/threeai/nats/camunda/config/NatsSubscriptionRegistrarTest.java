...
/**
 * Fans out {@code spring.nats.camunda.subscriptions[*]} entries to either a real {@link
 * com.threeai.nats.camunda.inbound.JetStreamMessageCorrelationSubscriber} or a real {@link
 * com.threeai.nats.camunda.inbound.NatsMessageCorrelationSubscriber} depending on {@code
...
class NatsSubscriptionRegistrarTest {
    ...
    private CamundaNatsProperties properties;
    ...
    @BeforeEach
    void setUp() {
        properties = new CamundaNatsProperties();
