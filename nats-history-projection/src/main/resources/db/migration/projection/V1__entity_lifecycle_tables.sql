...
-- Owner (write): HistoryProjectionConsumer (merge-upsert)
...
-- ============================================================================
-- process_instance_history (PROCINST) -- core-4 pattern 1/2/3 anchor table.
-- ============================================================================
CREATE TABLE process_instance_history (
    ...
    business_key             VARCHAR(255),                       -- CONFIDENTIAL/conditional PII (DP-2/DP-8)
...
-- ============================================================================
-- activity_instance_history (ACTINST) -- bulk, ~90% of volume (DETAIL/VARINST/ACTINST).
-- ============================================================================
...
-- ============================================================================
-- incident_history (INCIDENT) -- AUDIT-CRITICAL (PO-Q5 default set). legal_hold defaults TRUE.
-- ============================================================================
CREATE TABLE incident_history (
    ...
    anonymized_at          TIMESTAMPTZ,
    legal_hold              BOOLEAN NOT NULL DEFAULT TRUE,          -- audit-critical => legal-retention exception (ADR-0017/0018)
    PRIMARY KEY (id, partition_anchor_at)
) PARTITION BY RANGE (partition_anchor_at);
...
-- ============================================================================
-- case_instance_history (CASEINST) -- CMMN, low volume.
-- ============================================================================
CREATE TABLE case_instance_history (
    ...
    business_key          VARCHAR(255),                          -- CONFIDENTIAL/conditional PII
    create_time           TIMESTAMPTZ,
