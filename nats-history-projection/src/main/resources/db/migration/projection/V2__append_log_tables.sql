...
-- Owner (write): HistoryProjectionConsumer
--
...
-- ============================================================================
-- variable_detail_history (DETAIL) -- bulk, largest volume (first cutover candidate, volume-priority).
-- ============================================================================
...
-- ============================================================================
-- operation_log_history (OP_LOG) -- AUDIT-CRITICAL. The audit trail itself (who-did-what).
...
-- ============================================================================
-- ext_task_log_history (EXT_TASK_LOG) -- AUDIT-CRITICAL. legal_hold defaults TRUE.
-- ============================================================================
...
-- ============================================================================
-- decision_evaluation_history (DECINST) -- bulk; decision inputs/outputs may carry PII risk.
-- ============================================================================
CREATE TABLE decision_evaluation_history (
    ...
    inputs                      JSONB,                            -- CONFIDENTIAL -> content carries PII risk
    outputs                     JSONB,
    stream_sequence             BIGINT      NOT NULL,
    event_time                  TIMESTAMPTZ NOT NULL,
    created_at                  TIMESTAMPTZ NOT NULL DEFAULT now(),
...
-- ============================================================================
-- batch_history (BATCH) -- bulk, batch metadata (carries no PII values -- job counters only).
-- ============================================================================
