 ...
 * One instance per partition (ARCH-Q3, N=8 default,
 ...
 *
 * <p><b>CQ-1 (proposed — pseudonym-vault write ownership):</b> this consumer previously
...
public class HistoryProjectionConsumer {
    ...
    /**
     * FINDING-004 (code review): custody-transfer is complete (ack) ONLY once the DLQ publish
    ...
    /**
     * FINDING-001 (code review decision, 2026-07-20): {@code event_time} is a range-partition
    ...
    private void applyLargePayload(String historyClass, Map<String, Object> fields, byte[] payload) {
        if (HistoryClassNames.EXT_TASK_LOG.equals(historyClass)) {
            ...
            // column in this increment's schema (only VARINST's variable_instance_history does,
