...
/**
 * Ops-only inspection consumer for {@code dlq.history.>}.
 * {@code RES_HISTORY_DLQ_ACCESS_DENIED} is enforced at the subject-ACL layer
 * (primary defense) — this class does not implement authz
 * itself, only metrics/visibility (US-E2). CB-protected (increment 1
