...
/**
 * Operator-triggered rollback (BR-CUT-003, ADR-0015).
 * Writes {@code cutover.<engineId>.<class>=false}, sets
 ...
 *
 * <p><b>No permanent dual-run (NFR-R5):</b> this class only ever moves a class BACK to
