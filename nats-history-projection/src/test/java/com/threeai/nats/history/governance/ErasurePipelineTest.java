...
class ErasurePipelineTest {
    ...
    /**
     * CQ-3 (proposed): DP-10/FR-G2 primary bulk-PII erasure targets — VARINST/DETAIL
    ...
    /**
     * FINDING-002 (code review, MINOR): proves {@code verifyErasure} actually DETECTS a still-
