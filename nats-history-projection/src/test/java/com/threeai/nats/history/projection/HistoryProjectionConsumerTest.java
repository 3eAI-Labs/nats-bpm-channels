...
class HistoryProjectionConsumerTest {
    ...
    static void setUp() throws Exception {
        ...
        // FINDING-001 (code review): a dated partition (rather than relying on the catch-all
    ...
    /**
     * FINDING-001 (code review decision, 2026-07-20): redelivery e2e on an audit-critical
