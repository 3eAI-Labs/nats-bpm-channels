...
| `nats-history-projection` **(YENİ modül)** | **82.6%** (1089/1319) | 72.5% (251/346) | N/A (yeni) | ✅ eşik ÜSTÜNDE, bu turda 80.5%→82.6% iyileşti |
| `nats-bpm-bench` | **89.7%** (420/468) | 75.4% (98/130) | N/A | ✅ eşik üstünde |
| **Ağırlıklı reaktör ortalaması** | **78.7%** (4561/5794) | — | ~74.0% | ✅ basamak-1 ortalamasının ÜZERİNDE |

**`nats-history-projection` (YENİ, basamak-2'nin ana modülü) 82.6% ile hem >80% eşiğini geçiyor hem de tüm reaktörün en sağlıklı business-logic modüllerinden biri.**
