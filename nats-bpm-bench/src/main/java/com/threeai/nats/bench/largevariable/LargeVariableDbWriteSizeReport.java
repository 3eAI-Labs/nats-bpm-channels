...
/**
 * D-C' threshold-calibration fingerprint (increment 3 design, §3 bench
 * item). Unlike increment 2's {@code HistoryDbWriteOpReport} (op COUNT — every offloaded write
 * disappears from {@code ACT_HI_*} entirely), increment 3's externalized value is NOT eliminated
