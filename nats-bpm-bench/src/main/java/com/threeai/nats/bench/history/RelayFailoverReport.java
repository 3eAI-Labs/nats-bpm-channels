...
/**
 * {@link RelayFailoverBenchScenario}'s measurement output (handed-over verification #5,
 * RTO/RPO verification, test spec (h) — real measurement).
 *
 ...
 *                                   ({@code 2 * relayCyclePeriodSeconds}) —
 *                                   this increment's RTO bound
