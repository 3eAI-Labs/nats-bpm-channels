...
/**
 * Extends increment 1 {@code BenchEnvironment.ensureStreams()} — provisions {@code HISTORY}
 ...
 * Production stream provisioning follows the SAME ops-reviewed-YAML
 * discipline as increment 1 (see `JetStreamStreamManager`'s own class-level
 * doc) — this class exists so bench/CI environments can self-provision the same shape.
 *
 * <p><b>CODER-NOTE (VAL_HISTORY_STREAM_PROVISIONING_MISSING, error registry §3.1 row 3):</b>
