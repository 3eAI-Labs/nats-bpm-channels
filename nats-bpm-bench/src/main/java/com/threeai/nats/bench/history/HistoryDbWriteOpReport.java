...
/**
 * D-F fingerprint report for {@link HistoryBenchScenario}.
 *
...
public record HistoryDbWriteOpReport(
     ...
     *
     * <p><b>CODER-NOTE (FINDING-004, code review — BUS_BENCH_BASELINE_MISSING /
     * SYS_BENCH_HISTORY_SLI_DRIFT not yet emitted):</b> the error registry also names two
