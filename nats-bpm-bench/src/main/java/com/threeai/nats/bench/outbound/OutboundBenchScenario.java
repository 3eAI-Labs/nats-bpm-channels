...
/**
 * Increment 4 outbound-handoff DB-write-op profile (increment 4 design, §3): one shared
...
public class OutboundBenchScenario implements AutoCloseable {
    ...
    // Code review FINDING-003: underscore-only -- a dotted messageType would fail
