...
/**
 * {@code history-relay-leader} failover RTO/RPO measurement (handed-over verification #5,
 * test spec (h)).
 *
 * <p><b>Real measurement (per explicit task instruction) — supersedes the earlier
 ...
 * "each with its own {@code HistoryOutboxRelay} instance"; a full Testcontainers/engine boot per
 ...
 * </ol>
 *
 * <p><b>QA-FINDING (measured, not a defect):</b> because recovery is driven purely by
