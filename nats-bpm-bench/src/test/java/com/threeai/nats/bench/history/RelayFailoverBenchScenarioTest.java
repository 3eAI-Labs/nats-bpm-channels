...
/**
 * Real relay-failover RTO/RPO measurement (test spec (h), handed-over verification
 * #5) — supersedes the earlier design-only placeholder
 * (`RelayFailoverBenchScenario`'s CODER-NOTE) now that QA testing is in scope.
 *
