...
/**
 * Real outbound-relay-failover RTO/RPO measurement — increment 4 mirror of {@code
 * RelayFailoverBenchScenarioTest} (increment 2's real-measurement precedent), applied to {@code
 * OutboundMessageRelay} (increment 4, decisions D-A'/D-F'). QA reliability suite.
 *
