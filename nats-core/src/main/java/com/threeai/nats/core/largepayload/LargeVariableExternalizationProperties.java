...
/**
 * {@code history.large-variable.*} — increment 3 D-C' size-threshold + sweep cadence.
 * Engine-neutral (nats-core, shared by
...
public class LargeVariableExternalizationProperties {
    ...
    /** @return {@code true} if {@code byteLength} exceeds the threshold (D-C' "above threshold only"). */
