 ...
 *
 * <p><b>CODER-NOTE (LLD deviation):</b> the error registry specifies this class as
 * {@code extends org.flowable.common.engine.api.FlowableException}. {@code nats-core} has zero
 * dependency on any engine module by architectural invariant (confirmed by the current
 * {@code nats-core/pom.xml}), so this class extends
...
public class TopicNamespaceCollisionException extends RuntimeException {
    ...
    /**
     * Increment 4 (decision D-E') — generalizes the reservation message so the
