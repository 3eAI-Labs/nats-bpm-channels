...
/**
 * The 15 {@code ACT_HI_*} class names this increment offloads (6
...
public final class HistoryClassNames {
    ...
    /** Fail-safe-bulk fallback when the engine produces an event this increment does not classify. */
    ...
    /** PO-Q5 default audit-critical set — callers may override via config. */
