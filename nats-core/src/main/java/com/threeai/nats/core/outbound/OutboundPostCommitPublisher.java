...
/**
 * Best-effort/at-most-once outbound publish path (increment 4, decisions D-A'/D-C') —
 ...
 * of the increment 1/2 post-commit {@code TransactionListener} pattern ({@code
...
public class OutboundPostCommitPublisher {
    ...
    public void publish(OutboundMessageDraft draft) {
        try {
            ...
            // engine transaction (3rd use of this exact increment 1/2 pattern).
