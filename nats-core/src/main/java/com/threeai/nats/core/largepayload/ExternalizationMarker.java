...
/**
 * Self-describing RUNTIME-side reference marker (increment 3, decisions
 * D-A'/D-E'). Written into the engine's {@code byteArrayValue} field ({@code ACT_GE_BYTEARRAY})
 ...
 *
 * <p><b>CODER-NOTE (why {@code byteArrayValue}, not {@code TEXT_}/{@code TEXT2_} as the increment 3
 * design originally sketched):</b> fork-verified against the compiled 7.24.0 engine source
