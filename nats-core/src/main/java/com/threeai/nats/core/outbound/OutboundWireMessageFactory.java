...
/**
 * Builds the single outbound-handoff wire-contract shape (increment 4, the shared wire contract)
 * used by both publish paths — the critical outbox+relay path and the
