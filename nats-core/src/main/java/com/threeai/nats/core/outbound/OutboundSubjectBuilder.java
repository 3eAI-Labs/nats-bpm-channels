...
/**
 * Builds the increment 4 outbound-handoff subject scheme (decision D-E'):
 * {@code events.<engineId>.<type>.<processInstanceId>} — a direct projection of the increment 2
 ...
 *
 * <p><b>Code review FINDING-003 (MINOR — robustness):</b> {@code messageType} is tenant-defined,
