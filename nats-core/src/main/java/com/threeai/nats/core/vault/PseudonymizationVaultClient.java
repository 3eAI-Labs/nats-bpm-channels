...
/**
 * Vault-DB CLIENT — talks to the physically separate pseudonym-vault Postgres (ARCH-Q2).
 *
 * <p><b>FINDING-003 (code review, MINOR — stale Javadoc, updated after CQ-1):</b> {@link
 ...
 * #deleteMapping} (erasure-triggered hard-delete, ADR-0016 "erasure = deleting the map row") and
 ...
 * PseudonymVaultDataSourceProperties.vaultColumnEncryptionKeyRef} is documented as an
 * OpenBao/deploy-secret reference (not the secret itself); resolving that reference is
