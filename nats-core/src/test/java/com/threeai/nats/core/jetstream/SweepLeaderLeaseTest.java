...
class SweepLeaderLeaseTest {
    ...
    @Test
    void increment2Overload_usesCustomBucketAndKeyPrefix_notDefault() throws Exception {
        // history-relay-leader reuse -- separate bucket/key namespace from
    ...
    // NEW-001 (implementation re-run, decision 2026-07-21): heldRevision must be reset to null on
