...
/**
 * QA reliability suite -- BR-REL-001 applied to
 * increment 4's {@code OutboundMessageRelay} (D-F' custody-transfer): the SAME three crash-points
...
class OutboundMessageRelayCustodyTransferTest {
    ...
    /**
     * Crash-point 2 (pre-publish / relay node restart): the outbox row is durable and untouched
