 ...
 * publish-failure retains the row (never publish-then-forget). Direct mirror of increment 2's
...
class OutboundMessageRelayTest {
    ...
    /**
     * A relay crash AFTER a successful PubAck but BEFORE the row's DELETE (real increment 4 failure
