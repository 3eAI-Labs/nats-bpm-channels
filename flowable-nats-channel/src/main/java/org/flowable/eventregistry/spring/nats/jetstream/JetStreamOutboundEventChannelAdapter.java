...
/**
 * D-G' (increment 4) hardening: on publish failure, routes to a DLQ subject
 ...
 * (throw-only) — DLQ routing is opt-in via {@link
 * org.flowable.eventregistry.spring.nats.channel.NatsOutboundChannelModel#getDlqSubject()}
    ...
    public void sendEvent(String rawEvent, Map<String, Object> headerMap) {
        ...
        try {
            ...
            if (metrics != null) {
                ...
                // Code review FINDING-002: generic D-G' publish-outcome metric shared by both
