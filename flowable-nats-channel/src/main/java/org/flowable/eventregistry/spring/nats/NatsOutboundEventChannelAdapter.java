...
/**
 * D-G' (increment 4) hardening: the "currently a bare {@code connection.publish}" gap
 ...
 * already realizes the "post-commit / at-least-once split" the design brief calls for structurally,
 ...
 *
 * <p><b>CODER-QUESTION (implementation return report):</b> whether Flowable's {@code sendEvent} call runs
 * INSIDE or OUTSIDE the engine's own command transaction (increment 4 design, open item #3) was not
...
public class NatsOutboundEventChannelAdapter implements OutboundEventChannelAdapter<String> {
    ...
    /** Code review FINDING-002: {@code metrics} wires {@code flowableOutboundPublishedCount}/
