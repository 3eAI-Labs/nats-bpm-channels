...
class NatsOutboundEventChannelAdapterTest {
    ...
    // --- QA review (round 2): core-publish throws, no DLQ configured ---
    ...
    // --- Code review FINDING-002 (MINOR — observability): flowableOutbound* metrics wired ---
