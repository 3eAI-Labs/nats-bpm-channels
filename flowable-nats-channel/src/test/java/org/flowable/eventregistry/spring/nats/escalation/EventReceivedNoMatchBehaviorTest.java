...
/**
 * {@code eventReceived} no-match behavior (HLD §11 item 6c,
 ...
 * (line ~142) was written against speculatively (CODER-QUESTION).
 *
 ...
 * {@code doThrow(...)}. This is reported as a QA finding, not fixed here
 * (test-only scope) — see the QA report's DECISION_MATRIX/TEST_SPEC section.
 */
