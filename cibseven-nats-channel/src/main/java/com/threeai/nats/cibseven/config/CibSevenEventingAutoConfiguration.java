...
import com.threeai.nats.cibseven.eventing.DefinitionSubscriberFactory;
import com.threeai.nats.cibseven.eventing.EventingDeployer;
import com.threeai.nats.cibseven.eventing.EventingReconcileScheduler;
import com.threeai.nats.cibseven.eventing.EventingReconciler;
import com.threeai.nats.cibseven.eventing.EventingRegistry;
import com.threeai.nats.cibseven.eventing.LocationDefinitionLoader;
import com.threeai.nats.cibseven.eventing.OverlayedOutboundClassification;
 ...
 * {@code spring.nats.cibseven.eventing.enabled=true} (D-F v2, default false): absent the gate,
 ...
 */
@AutoConfiguration(after = CibSevenNatsAutoConfiguration.class)
@ConditionalOnClass(org.cibseven.bpm.engine.ProcessEngine.class)
@ConditionalOnProperty(prefix = "spring.nats.cibseven.eventing", name = "enabled", havingValue = "true")
@EnableConfigurationProperties(CibSevenEventingProperties.class)
public class CibSevenEventingAutoConfiguration {
    ...
    @Bean
    @Primary
    public OverlayedOutboundClassification cibsevenOutboundClassificationOverlay(
    ...
    public EventingReconciler eventingReconciler(RepositoryService repositoryService,
            ...
            CibSevenEventingProperties properties, ResourceLoader resourceLoader,
    ...
    public EventingReconcileScheduler eventingReconcileScheduler(EventingReconciler eventingReconciler,
            EventingRegistry eventingRegistry, CibSevenEventingProperties properties,
