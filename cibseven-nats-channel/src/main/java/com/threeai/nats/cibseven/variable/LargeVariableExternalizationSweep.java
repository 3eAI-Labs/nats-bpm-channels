...
/**
 * Leader-elected, catch-all externalization sweep (increment 3, decision
 ...
 * failure, ...): the fast path is best-effort by design (D-A', increment 3 design §5), so this sweep is what
