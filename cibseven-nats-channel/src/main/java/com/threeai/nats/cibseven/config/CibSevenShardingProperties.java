...
/**
 * {@code spring.nats.cibseven.sharding.*} — the instance-sharding gate (docs/13 D-F house
 ...
 */
@ConfigurationProperties(prefix = "spring.nats.cibseven.sharding")
public class CibSevenShardingProperties {
