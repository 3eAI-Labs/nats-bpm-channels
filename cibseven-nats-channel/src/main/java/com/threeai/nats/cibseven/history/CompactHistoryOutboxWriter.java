 ...
 * gap in the audit-critical flow itself — matching ADR-0016's explicit "if the vault is
 * unreachable the AUDIT flow is NOT blocked" contract). {@code vaultClient} is nullable —
