 ...
 * delegate instead (fork-evidence rationale: §1.4 below).
 *
 * <p><b>cibseven-nats-channel targets {@code org.cibseven.*}</b> (module convention, design review
 * F-001); the {@code cadenzaflow-nats-channel} byte-mirror targets {@code org.cadenzaflow.*} only
 * (ADR-0007).
 *
 ...
 */
public class NatsHistoryEventHandler implements org.cibseven.bpm.engine.impl.history.handler.HistoryEventHandler {
     ...
     * over {@code handleEvent(...)} (fork-verified, HLD §11 item 2) — this override exists only
     ...
     * can theoretically be upgraded to a live KV watch in a future increment without any fork
