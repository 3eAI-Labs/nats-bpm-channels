 ...
 * (audit-critical) and {@link HistoryPostCommitPublisher} (bulk) — per NFR-M3 "both paths use
 * the SAME subject/dedup scheme". Package-private: not part of the LLD's public class list, a
