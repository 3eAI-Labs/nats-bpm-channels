...
/**
 * {@code spring.nats.cibseven.a2.*} — umbrella-lock parameters (ADR-0001, BR-A2-006/007,
 ...
 */
@ConfigurationProperties(prefix = "spring.nats.cibseven.a2")
public class A2Properties {
    ...
    /** Only LITERAL {@code camunda:topic} values (03_classes/2_cibseven_a2.md §1.3). */
