...
/**
 * D-A' outbound-handoff seam: the transactional-safe successor of the deleted {@code
 ...
 *
 * <p><b>ADIM-0 verified (implementation return report):</b> {@code ExecutionListener.notify(...)} runs
...
public class NatsOutboundPublisher implements ExecutionListener {
    ...
    public void notify(DelegateExecution execution) throws Exception {
        ...
        try {
            ...
            // Code review FINDING-003 (MINOR) -- an unsafe messageType (contains '.', '*', '>',
        ...
        if (outcome == OutboundClassification.CRITICAL) {
            ...
            // COMMITTED) -- increment 1/2 pattern's 3rd use.
