...
/**
 * Deferred/post-commit externalization worker (increment 3, decisions
 ...
 *
 * <p><b>CODER-NOTE (background executor, not a same-thread post-commit call — beyond increment 2's
 ...
 * by any of it. The increment 3 design §5 explicitly grants more flexibility than increment 2
 * here ("a softer transition than increment 2") — externalization failure only
 ...
 * instances that {@code CibSevenNatsAutoConfiguration}'s {@code ProcessEnginePlugin.preInit(...)}
...
public class LargeVariablePostCommitExternalizer {
    ...
    public void externalizeNow(String variableId) {
        ...
        try {
            ...
            // SYS_LARGE_VARIABLE_EXTERNALIZATION_FAILED -- soft-fail by design (D-A', increment 3 design §5):
