...
class LargeVariablePostCommitExternalizerTest {
    ...
    void setUp() {
        ...
        externalizer = new LargeVariablePostCommitExternalizer(largePayloadStore, properties, metrics, "cibseven");
    ...
    void externalizeNow_eligible_storesAndSetsMarker_incrementsMetric() {
        ...
        when(largePayloadStore.storeAndAcquireReference(current, "runtime.cibseven"))
        ...
        assertThatCode(() -> metrics.largeVariableExternalizedCount("cibseven")).doesNotThrowAnyException();
    }
