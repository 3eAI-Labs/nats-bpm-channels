...
/**
 * Fans out {@code spring.nats.cibseven.subscriptions[*]} entries to either a real {@link
 * com.threeai.nats.cibseven.inbound.JetStreamMessageCorrelationSubscriber} or a real {@link
 * com.threeai.nats.cibseven.inbound.NatsMessageCorrelationSubscriber} depending on {@code
...
class NatsSubscriptionRegistrarTest {
    ...
    private CibSevenNatsProperties properties;
    ...
    @BeforeEach
    void setUp() {
        properties = new CibSevenNatsProperties();
