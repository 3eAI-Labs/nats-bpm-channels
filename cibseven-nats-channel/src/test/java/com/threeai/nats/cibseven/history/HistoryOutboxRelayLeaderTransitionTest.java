...
/**
 * FINDING-004 (code review): {@code SYS_OUTBOX_RELAY_LEADER_LOST} transition detection.
 *
 * <p><b>NEW-001 (implementation re-run, decision 2026-07-21):</b> the original version of this test
...
class HistoryOutboxRelayLeaderTransitionTest {
    ...
    private static final String KEY = "sweep-leader.cibseven";
    ...
    void relayCycle_wasLeaderNowIsnt_logsLeadershipLostWarning() throws Exception {
        ...
        SweepLeaderLease leaderLease = new SweepLeaderLease(mock(JetStream.class), mock(JetStreamKvManager.class),
                connection, "cibseven", "pod-1", Duration.ofSeconds(240));
        ...
        HistoryOutboxRelay relay = new HistoryOutboxRelay(mock(DataSource.class), mock(JetStream.class),
                leaderLease, new HistoryOutboxProperties(), null, "cibseven");
