...
class ShardedTwoShardAcceptanceTest {
    ...
    void historyIngestSurface_isShardAgnostic_bothShardsOneStream() throws Exception {
        ...
        HistoryEventEnvelope fromShard0 = new HistoryEventEnvelope("cibseven", "ACT_HI_PROCINST",
                "start", "h1", "pi-0", "a", 0, Instant.now(), "{}");
        HistoryEventEnvelope fromShard1 = new HistoryEventEnvelope("cibseven", "ACT_HI_PROCINST",
