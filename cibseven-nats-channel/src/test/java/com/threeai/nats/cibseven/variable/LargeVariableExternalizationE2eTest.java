...
/**
 * Real embedded CibSeven engine (Testcontainers Postgres) + real content-addressed projection store
 ...
 * (increment 3, decisions D-A'/D-C'/D-E'/D-F').
 */
@Testcontainers
class LargeVariableExternalizationE2eTest {
    ...
    static void setUp() throws Exception {
        ...
        postCommitExternalizer = new LargeVariablePostCommitExternalizer(payloadStore, properties, null, "cibseven");
        ...
        SweepLeaderLease leaderLease = new SweepLeaderLease(jetStream, kvManager, natsConnection,
                leaderBucket, "sweep-leader.", "cibseven", "test-node", Duration.ofSeconds(60));
        sweep = new LargeVariableExternalizationSweep(
                engineDataSource, leaderLease, postCommitExternalizer, payloadStore, properties, "cibseven");
        ...
        // Mirrors CibSevenNatsAutoConfiguration's largeVariableProcessEnginePlugin bean, without Spring.
    ...
    /**
     * FINDING-001 probe (code review, ship-blocker): hard-deleting the OWNING PROCESS of a
    ...
    void hardDeleteProcess_soleReference_reconciliationReleasesAndDeletesPayload() {
        ...
        assertThat(payloadStore.currentRuntimeReference("cibseven", variableId)).isEmpty(); // ledger row cleaned up too
    }
    ...
    void hardDeleteProcess_sharedReference_survivesUntilLastReferrerDeleted() {
        ...
        assertThat(payloadStore.fetchByContentHash(contentHash)).isPresent();
        assertThat(payloadStore.currentRuntimeReference("cibseven", variableIdA)).isEmpty();
        assertThat(payloadStore.currentRuntimeReference("cibseven", variableIdB)).isPresent();
        ...
        assertThat(payloadStore.currentRuntimeReference("cibseven", variableIdB)).isEmpty();
    }
