...
class CibSevenEventingAutoConfigurationTest {

    private final ApplicationContextRunner runner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(CibSevenEventingAutoConfiguration.class))
    ...
    void gateOpen_wiresDeployerPluginReconcilerAndPrimaryOverlay() {
        runner.withPropertyValues("spring.nats.cibseven.eventing.enabled=true")
                .run(context -> {
    ...
    void gateOpen_unresolvableLocationFailsStartup_emptyWildcardDoesNot() {
        ...
        runner.withPropertyValues("spring.nats.cibseven.eventing.enabled=true",
                        "spring.nats.cibseven.eventing.definitions.locations=classpath:does-not-exist/*.event")
