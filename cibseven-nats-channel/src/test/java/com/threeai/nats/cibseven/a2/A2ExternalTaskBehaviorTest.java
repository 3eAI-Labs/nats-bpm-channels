...
/**
 * QA review fix (item 5, decision 2026-07-15) — in-tx variable capture. Only
 ...
 * VariableScope} without needing to mock CibSeven's static {@code Context}/{@code CommandContext}
 * bootstrap machinery (not done anywhere else in this codebase either — {@code execute()} itself
 * is exercised indirectly via the embedded-engine integration tests, e.g. {@code
 * CibSevenA2GuardTest}/{@code A2OrphanSweepFetchableParityIntegrationTest}).
 */
