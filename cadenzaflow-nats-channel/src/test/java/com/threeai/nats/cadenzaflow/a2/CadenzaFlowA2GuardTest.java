 ...
 * {@link A2ExternalTaskBehavior#execute} produces exactly ONE
 ...
 * infrastructure, not a repeat of the existing pattern (per the LLD test specification).
 */
class CadenzaFlowA2GuardTest {
