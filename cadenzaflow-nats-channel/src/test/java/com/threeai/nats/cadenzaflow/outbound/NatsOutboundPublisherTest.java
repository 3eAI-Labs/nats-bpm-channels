 ...
 * {@link VariableScope} without needing to mock CadenzaFlow's static {@code Context}/{@code
...
class NatsOutboundPublisherTest {
    ...
    void notify_unsupportedBpmnElement_skipsPublish_doesNotThrow_neverTouchesWriterOrPublisher() throws Exception {
        ...
        // so this is safely unit-testable without mocking CadenzaFlow's static command-context machinery.
