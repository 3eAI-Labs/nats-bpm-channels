...
/**
 * BR-REL-001 — QA review: the three custody-transfer
...
class HistoryOutboxCustodyTransferTest {
    ...
    private HistoryOutboxRelay newRelayAsLeader() throws Exception {
        ...
        return new HistoryOutboxRelay(dataSource, jetStream, leaderLease, new HistoryOutboxProperties(), null, "cadenzaflow");
    }

    /**
     * Crash-point 1 (pre-commit): a tx-injected failure AFTER {@code
    ...
    /**
     * Crash-point 2 (pre-publish / relay node restart): the outbox row is durable and
    ...
    /**
     * Crash-point 3 (pre-PubAck broker outage): the real NATS container is Docker-paused
