...
class CadenzaFlowEventingAutoConfigurationTest {

    private final ApplicationContextRunner runner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(CadenzaFlowEventingAutoConfiguration.class))
    ...
    void gateOpen_wiresDeployerPluginReconcilerAndPrimaryOverlay() {
        runner.withPropertyValues("spring.nats.cadenzaflow.eventing.enabled=true")
                .run(context -> {
    ...
    void gateOpen_unresolvableLocationFailsStartup_emptyWildcardDoesNot() {
        ...
        runner.withPropertyValues("spring.nats.cadenzaflow.eventing.enabled=true",
                        "spring.nats.cadenzaflow.eventing.definitions.locations=classpath:does-not-exist/*.event")
