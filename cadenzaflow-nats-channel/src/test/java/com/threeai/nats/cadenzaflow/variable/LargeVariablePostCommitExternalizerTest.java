...
import org.cadenzaflow.bpm.engine.impl.db.entitymanager.DbEntityManager;
...
class LargeVariablePostCommitExternalizerTest {
    ...
    void setUp() {
        ...
        externalizer = new LargeVariablePostCommitExternalizer(largePayloadStore, properties, metrics, "cadenzaflow");
    ...
    void externalizeNow_eligible_storesAndSetsMarker_incrementsMetric() {
        ...
        when(largePayloadStore.storeAndAcquireReference(current, "runtime.cadenzaflow"))
        ...
        assertThatCode(() -> metrics.largeVariableExternalizedCount("cadenzaflow")).doesNotThrowAnyException();
    }
