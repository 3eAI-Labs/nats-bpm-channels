...
import org.cadenzaflow.bpm.engine.impl.history.HistoryLevelNone;
...
class HistoryBootstrapValidatorTest {
    ...
    void validate_historyLevelFull_producesAllConfiguredClasses_noWarnNoThrow() {
        ...
        assertThatCode(() -> HistoryBootstrapValidator.validate(configuration, classification, "cadenzaflow"))
    ...
    void validate_historyLevelNone_mismatchIsWarnOnly_neverThrows() {
        ...
        // BA-Q4 decision: mismatch is WARN, not hard-reject -- must not throw even though HistoryLevelNone
        // produces nothing.
        assertThatCode(() -> HistoryBootstrapValidator.validate(configuration, classification, "cadenzaflow"))
                .doesNotThrowAnyException();
    }
