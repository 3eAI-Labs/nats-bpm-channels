 ...
 * {@code com.threeai.nats.cadenzaflow.inbound.SubscriptionConfig} (review MINOR-1, mirrored
 * per ADR-0007). {@code SubscriptionConfig}'s
...
public class A2ConsumerConfig {
     ...
     * TRANSIENT replies. QA review fix (decision 2026-07-15): was hardcoded
