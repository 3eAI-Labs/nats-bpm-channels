 ...
 * activities). CadenzaFlow field injection (`camunda:field`) would mutate INSTANCE state on that
 ...
 * stateless and thread-safe. See implementation return report CODER-NOTE.
 */
