...
/**
 * {@code spring.nats.cadenzaflow.eventing.*} — the Event-Registry-parity gate (docs/12 D-F v2).
 ...
 */
@ConfigurationProperties(prefix = "spring.nats.cadenzaflow.eventing")
public class CadenzaFlowEventingProperties {
