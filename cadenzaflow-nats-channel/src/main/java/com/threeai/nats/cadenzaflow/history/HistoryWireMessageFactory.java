 ...
 * (audit-critical) and {@link HistoryPostCommitPublisher} (bulk) — per NFR-M3 "BOTH paths use the
 * SAME subject/dedup scheme". Package-private: not part of the LLD's public class list, a
...
final class HistoryWireMessageFactory {
    ...
    /**
     * @param eventTime the ENGINE's real history-event timestamp (FINDING-001, code review,
     *                  decision 2026-07-20) — carried on the wire as {@link
     ...
     *                  increment classifies resolves one via {@code HistoryEventFieldExtractor
     *                  .eventTimeOf}.
     */
