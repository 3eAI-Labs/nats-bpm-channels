...
import org.cadenzaflow.bpm.engine.impl.batch.history.HistoricBatchEntity;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricActivityInstanceEventEntity;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricCaseInstanceEventEntity;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricDecisionEvaluationEvent;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricDetailEventEntity;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricExternalTaskLogEntity;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricIdentityLinkLogEventEntity;
...
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricScopeInstanceEvent;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricTaskInstanceEventEntity;
...
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricJobLogEventEntity;
 ...
 * {@code payload_scalar} JSONB) and
 * {@link HistoryPostCommitPublisher} (bulk wire payload). Also resolves the two fields
 ...
 * The outbox migration's column comment lists 11 named bounded fields for {@code payload_scalar}
...
final class HistoryEventFieldExtractor {
     ...
     * (ARCH-Q1 rare large payload; DETAIL byte-array
