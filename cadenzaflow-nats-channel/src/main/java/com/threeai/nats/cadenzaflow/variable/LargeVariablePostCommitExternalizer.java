 ...
 * by any of it. The increment 3 design explicitly grants more flexibility here than increment 2 had
 * ("allows a more flexible 'soft transition' than increment 2") — externalization failure only
...
public class LargeVariablePostCommitExternalizer {
    ...
    public void externalizeNow(String variableId) {
        ...
        try {
            ...
            // SYS_LARGE_VARIABLE_EXTERNALIZATION_FAILED -- soft-fail by design (D-A', increment 3):
