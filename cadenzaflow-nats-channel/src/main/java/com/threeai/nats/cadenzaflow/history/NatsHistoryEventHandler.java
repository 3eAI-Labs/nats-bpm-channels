...
/**
 * Composite, class-based router — the fork SPI entry point (BR-HDL-001/002/005/007,
 * ADR-0009). Registered into
 ...
 * delegate instead (fork-evidence rationale: validation deferred by design review, item #1; §1.4
 * below).
 *
