...
/**
 * Engine-side READER of the {@code history-cutover-state} KV bucket (LLD-Q3). Read ONCE at
 * engine bootstrap ({@code ProcessEngineConfigurationImpl.init()} happens exactly once —
 * fork-evidence, validation deferred by design review, item #1) — NOT watched live in v1 (ARCH-Q5
...
public class ClassCutoverStateRegistry {
    ...
    public ClassCutoverStateRegistry(com.threeai.nats.core.jetstream.JetStreamKvManager kvManager,
        ...
        // (deployment bootstrap order), not by this reader.
     ...
     * BR-CUT-002 "the gate stays open" spirit applied at boot time too).
     */
