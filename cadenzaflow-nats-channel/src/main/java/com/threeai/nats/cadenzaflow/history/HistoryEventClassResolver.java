 ...
 * increment offloads. Package-private decomposition out of
 * {@code NatsHistoryEventHandler} for direct unit-testability without engine bootstrap
 * (routing rule step 2: "if NOT IN the map → VAL_HISTORY_CLASS_UNCLASSIFIED").
 *
 ...
 * the engine-side emission is deferred). See CODER-QUESTIONS in the implementation return report.
 *
 ...
 * unpopulated by this increment. Not an oversight — a genuine fork-architecture gap outside this
...
final class HistoryEventClassResolver {
    ...
    static Optional<String> resolve(HistoryEvent historyEvent) {
        ...
        // engine events this increment does not (yet) offload; VAL_HISTORY_CLASS_UNCLASSIFIED.
